...
function TopRight() {
  ...
  listenKeys($iajsStore, ['zoom'], (value, oldValue, changed) => {
    setCurrentZoomScale(value.zoom)
  })
  ...
  return (
    <>
      <div className="flex-none w-80 flex flex-row items-center justify-end">
        <button
          type="button"
          onClick={() => handleToolClick(Mode.ZoomWidth)}
        ...
        <button
          type="button"
          onClick={() => handleToolClick(Mode.ZoomHeight)}
          className="mx-0.5 my-0.5 flex shrink-0 justify-center items-center gap-2 size-[24px] text-sm font-medium rounded-sm border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
        >
          <svg
            className="shrink-0 size-4"
        ...
        <button
          type="button"
          onClick={() => handleToolClick(Mode.ZoomFull)}
          className="mx-0.5 my-0.5 flex shrink-0 justify-center items-center gap-2 size-[24px] text-sm font-medium rounded-sm border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
        >
          <svg
            className="shrink-0 size-4"
        ...
        <button
          type="button"
          onClick={() => handleToolClick(Mode.ZoomOut)}
          className="mx-0.5 my-0.5 flex shrink-0 justify-center items-center gap-2 size-[24px] text-sm font-medium rounded-sm border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
        >
          <svg
            className="shrink-0 size-4"
        ...
        <div className="hs-dropdown relative [--placement:bottom] inline-flex mx-0.5 my-0.5">
          <button
          ...
          >
            <div className="hs-dropdown-open:ease-in hs-dropdown-open:opacity-100 hs-dropdown-open:scale-100 transition ease-out opacity-0 scale-95 duration-200 mt-0.5 origin-top-left min-w-20 bg-white shadow-md rounded-lg dark:bg-neutral-800 dark:border dark:border-neutral-700 dark:divide-neutral-700">
              <div className="p-1 space-y-0.5">
                {canvasZoomPresets.reverse().map((zoom) => {
                  return (
                    <a
                      key={zoom}
        ...
        <button
          type="button"
          onClick={() => handleToolClick(Mode.ZoomIn)}
          className="ml-0.5 mr-2 my-0.5 flex shrink-0 justify-center items-center gap-2 size-[24px] text-sm font-medium rounded-sm border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
        >
          <svg
            className="shrink-0 size-4"
            xmlns="http://www.w3.org/2000/svg"
