...
function Right() {
  ...
  return (
    <>
      ...
      >
        <div
          className="flex flex-col grow border border-gray-200 rounded-lg dark:border-neutral-700 w-full"
      ...
      "minSize": 10.0
            ...
            style={{ flex: '151 0px' }}
          >
            <div className="flex items-start justify-center h-full p-0.5 text-gray-800 dark:text-neutral-200">
              <RightTop />
            </div>
          </div>
          <div
          ...
          "minSize": 20.0
            ...
            style={{ flex: '35 1 0px' }}
          >
            <div className="flex items-start justify-center h-full p-3 text-gray-800 dark:text-neutral-200 overflow-y-auto [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
              <RightCenter />
            </div>
          </div>
          <div
      ...
      "minSize": 20.0
            ...
            style={{ flex: '50 1 0px' }}
          >
            <div className="flex items-start justify-start h-full w-full p-0.5 text-gray-800 dark:text-neutral-200 overflow-auto">
              <RightBottom />
            </div>
          </div>
        </div>
