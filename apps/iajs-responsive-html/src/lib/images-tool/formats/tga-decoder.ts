...
export class TgaDecoder implements Decoder {
  ...
  private decodeRgb(): MemoryImage | undefined {
    ...
    const hasAlpha =
      bpp === 16 ||
      bpp === 32 ||
      (this._info.hasColorMap && (this._info.colorMapDepth === 16 || this._info.colorMapDepth === 32))
  ...
  public decodeFrame(_frameIndex: number): MemoryImage | undefined {
    ...
    } else if (this._info.imageType === TgaImageType.rgbRle || this._info.imageType === TgaImageType.paletteRle) {
