...
export class TgaInfo implements DecodeInfo {
  ...
  public get hasColorMap(): boolean {
    return this._imageType === TgaImageType.palette || this._imageType === TgaImageType.paletteRle
  }
  ...
  public read(header: InputBuffer<Uint8Array>): void {
    ...
    // 2
    this._imageType = it < TgaImageTypeLength ? (it as TgaImageType) : TgaImageType.none
    // 3
  ...
  public isValid(): boolean {
    if (this._pixelDepth !== 8 && this._pixelDepth !== 16 && this._pixelDepth !== 24 && this._pixelDepth !== 32) {
      return false
    }
    ...
    if (this.hasColorMap) {
      ...
      if (this._colorMapDepth !== 16 && this._colorMapDepth !== 24 && this._colorMapDepth !== 32) {
        return false
      }
