...
export class JpegData {
  ...
  private readonly _quantizationTables = ArrayUtils.fill<Int16Array | undefined>(
    JpegData.numQuantizationTables,
    undefined,
  )
  ...
  private readonly _huffmanTablesAC: Array<Array<HuffmanNode | undefined> | undefined> = []
  public get huffmanTablesAC(): Array<Array<HuffmanNode | undefined> | undefined> {
    return this._huffmanTablesAC
  }

  private readonly _huffmanTablesDC: Array<Array<HuffmanNode | undefined> | undefined> = []
  public get huffmanTablesDC(): Array<Array<HuffmanNode | undefined> | undefined> {
  ...
  private readMarkers(): void {
    ...
    while (marker !== JpegMarker.eoi && !this._input.isEOS) {
      ...
      switch (marker) {
        ...
        default:
          if (this._input.get(-3) === 0xff && this._input.get(-2) >= 0xc0 && this._input.get(-2) <= 0xfe) {
   ...
   */
  private static buildHuffmanTable(codeLengths: Uint8Array, values: Uint8Array): Array<HuffmanNode | undefined> {
    let k = 0
   ...
   */
  private static buildComponentData(component: JpegComponent): Array<Uint8Array | undefined> {
    const blocksPerLine = component.blocksPerLine
    const blocksPerColumn = component.blocksPerColumn
    const samplesPerLine = blocksPerLine << 3
    const R = new Int32Array(64)
    const r = new Uint8Array(64)
    const lines = ArrayUtils.fill<Uint8Array | undefined>(blocksPerColumn * 8, undefined)
