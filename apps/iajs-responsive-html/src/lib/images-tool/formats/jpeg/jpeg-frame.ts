...
export class JpegFrame {
  ...
  public prepare(): void {
    ...
    for (const [_, component] of this._components) {
      const blocksPerLine = Math.ceil((Math.ceil(this._samplesPerLine / 8) * component.hSamples) / this._maxHSamples)
      ...
      const blocks = ArrayUtils.generate<Int32Array[]>(blocksPerColumnForMcu, (_) =>
        ArrayUtils.generate<Int32Array>(blocksPerLineForMcu, (_) => new Int32Array(64)),
      )
