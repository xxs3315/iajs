...
export class VP8LInternal extends VP8L {
   ...
   */
  public decodeImageStream(xsize: number, ysize: number, isLevel0: boolean): Uint32Array | undefined {
   ...
   * @returns {boolean} True if decoding was successful, otherwise false.
   */
  public decodeAlphaData(width: number, height: number, lastRow: number): boolean {
