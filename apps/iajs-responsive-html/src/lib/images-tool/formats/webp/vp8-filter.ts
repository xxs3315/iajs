...
export class VP8Filter {
   ...
   */
  private static store(dst: InputBuffer<Uint8Array>, di: number, x: number, y: number, v: number): void {
    dst.set(di + x + y * VP8.bps, VP8Filter.clip8b(dst.get(di + x + y * VP8.bps) + BitUtils.sshR(v, 3)))
  }
   ...
   */
  private static store2(dst: InputBuffer<Uint8Array>, y: number, dc: number, d: number, c: number): void {
  ...
  private static rd4(dst: InputBuffer<Uint8Array>): void {
    ...
    dst.set(VP8Filter.dst(0, 2), dst.set(VP8Filter.dst(1, 3), VP8Filter.avg3(i, j, K)))
    dst.set(VP8Filter.dst(0, 1), dst.set(VP8Filter.dst(1, 2), dst.set(VP8Filter.dst(2, 3), VP8Filter.avg3(x, i, j))))
    dst.set(
      VP8Filter.dst(0, 0),
      dst.set(VP8Filter.dst(1, 1), dst.set(VP8Filter.dst(2, 2), dst.set(VP8Filter.dst(3, 3), VP8Filter.avg3(a, x, i)))),
    )
    dst.set(VP8Filter.dst(1, 0), dst.set(VP8Filter.dst(2, 1), dst.set(VP8Filter.dst(3, 2), VP8Filter.avg3(b, a, x))))
    dst.set(VP8Filter.dst(2, 0), dst.set(VP8Filter.dst(3, 1), VP8Filter.avg3(c, b, a)))
  ...
  private static ld4(dst: InputBuffer<Uint8Array>): void {
    ...
    dst.set(VP8Filter.dst(1, 0), dst.set(VP8Filter.dst(0, 1), VP8Filter.avg3(b, c, d)))
    dst.set(VP8Filter.dst(2, 0), dst.set(VP8Filter.dst(1, 1), dst.set(VP8Filter.dst(0, 2), VP8Filter.avg3(c, d, e))))
    dst.set(
      VP8Filter.dst(3, 0),
      dst.set(VP8Filter.dst(2, 1), dst.set(VP8Filter.dst(1, 2), dst.set(VP8Filter.dst(0, 3), VP8Filter.avg3(d, e, f)))),
    )
    dst.set(VP8Filter.dst(3, 1), dst.set(VP8Filter.dst(2, 2), dst.set(VP8Filter.dst(1, 3), VP8Filter.avg3(e, f, g))))
    dst.set(VP8Filter.dst(3, 2), dst.set(VP8Filter.dst(2, 3), VP8Filter.avg3(f, g, h)))
  ...
  private static vr4(dst: InputBuffer<Uint8Array>): void {
    ...
    dst.set(VP8Filter.dst(0, 0), dst.set(VP8Filter.dst(1, 2), VP8Filter.avg2(x, a)))
    dst.set(VP8Filter.dst(1, 0), dst.set(VP8Filter.dst(2, 2), VP8Filter.avg2(a, b)))
    dst.set(VP8Filter.dst(2, 0), dst.set(VP8Filter.dst(3, 2), VP8Filter.avg2(b, c)))
    ...
    dst.set(VP8Filter.dst(0, 1), dst.set(VP8Filter.dst(1, 3), VP8Filter.avg3(i, x, a)))
    dst.set(VP8Filter.dst(1, 1), dst.set(VP8Filter.dst(2, 3), VP8Filter.avg3(x, a, b)))
    dst.set(VP8Filter.dst(2, 1), dst.set(VP8Filter.dst(3, 3), VP8Filter.avg3(a, b, c)))
  ...
  private static vl4(dst: InputBuffer<Uint8Array>): void {
    ...
    dst.set(VP8Filter.dst(1, 0), dst.set(VP8Filter.dst(0, 2), VP8Filter.avg2(b, c)))
    dst.set(VP8Filter.dst(2, 0), dst.set(VP8Filter.dst(1, 2), VP8Filter.avg2(c, d)))
    dst.set(VP8Filter.dst(3, 0), dst.set(VP8Filter.dst(2, 2), VP8Filter.avg2(d, e)))

    dst.set(VP8Filter.dst(0, 1), VP8Filter.avg3(a, b, c))
    dst.set(VP8Filter.dst(1, 1), dst.set(VP8Filter.dst(0, 3), VP8Filter.avg3(b, c, d)))
    dst.set(VP8Filter.dst(2, 1), dst.set(VP8Filter.dst(1, 3), VP8Filter.avg3(c, d, e)))
    dst.set(VP8Filter.dst(3, 1), dst.set(VP8Filter.dst(2, 3), VP8Filter.avg3(d, e, f)))
  ...
  private static hu4(dst: InputBuffer<Uint8Array>): void {
    ...
    dst.set(VP8Filter.dst(2, 0), dst.set(VP8Filter.dst(0, 1), VP8Filter.avg2(j, k)))
    dst.set(VP8Filter.dst(2, 1), dst.set(VP8Filter.dst(0, 2), VP8Filter.avg2(k, l)))
    dst.set(VP8Filter.dst(1, 0), VP8Filter.avg3(i, j, k))
    dst.set(VP8Filter.dst(3, 0), dst.set(VP8Filter.dst(1, 1), VP8Filter.avg3(j, k, l)))
    dst.set(VP8Filter.dst(3, 1), dst.set(VP8Filter.dst(1, 2), VP8Filter.avg3(k, l, l)))
    dst.set(
      VP8Filter.dst(3, 2),
      dst.set(
        VP8Filter.dst(2, 2),
        dst.set(
          VP8Filter.dst(0, 3),
          dst.set(VP8Filter.dst(1, 3), dst.set(VP8Filter.dst(2, 3), dst.set(VP8Filter.dst(3, 3), l))),
        ),
      ),
    )
  }
  ...
  private static hd4(dst: InputBuffer<Uint8Array>): void {
    ...
    dst.set(VP8Filter.dst(0, 0), dst.set(VP8Filter.dst(2, 1), VP8Filter.avg2(i, x)))
    dst.set(VP8Filter.dst(0, 1), dst.set(VP8Filter.dst(2, 2), VP8Filter.avg2(j, i)))
    dst.set(VP8Filter.dst(0, 2), dst.set(VP8Filter.dst(2, 3), VP8Filter.avg2(k, j)))
    ...
    dst.set(VP8Filter.dst(1, 0), dst.set(VP8Filter.dst(3, 1), VP8Filter.avg3(i, x, a)))
    dst.set(VP8Filter.dst(1, 1), dst.set(VP8Filter.dst(3, 2), VP8Filter.avg3(j, i, x)))
    dst.set(VP8Filter.dst(1, 2), dst.set(VP8Filter.dst(3, 3), VP8Filter.avg3(k, j, i)))
  ...
  private doFilter6(p: InputBuffer<Uint8Array>, step: number): void {
    ...
    const a = VP8Filter.sclip1[1020 + 3 * (q0 - p0) + VP8Filter.sclip1[1020 + p1 - q1]]
    // eq. to ((3 * a + 7) * 9) >>> 7
   ...
   */
  private hev(p: InputBuffer<Uint8Array>, step: number, thresh: number): boolean {
    const p1 = p.get(-2 * step)
    const p0 = p.get(-step)
    const q0 = p.get(0)
    const q1 = p.get(step)
    return VP8Filter.abs0[255 + p1 - p0] > thresh || VP8Filter.abs0[255 + q1 - q0] > thresh
  }
   ...
   */
  private needsFilter(p: InputBuffer<Uint8Array>, step: number, thresh: number): boolean {
    const p1 = p.get(-2 * step)
    const p0 = p.get(-step)
    const q0 = p.get(0)
    const q1 = p.get(step)
    return 2 * VP8Filter.abs0[255 + p0 - q0] + VP8Filter.abs1[255 + p1 - q1] <= thresh
  }
   ...
   * @returns {boolean} True if filtering is needed, false otherwise.
   */
  private needsFilter2(p: InputBuffer<Uint8Array>, step: number, t: number, it: number): boolean {
   ...
   */
  public simpleVFilter16(p: InputBuffer<Uint8Array>, stride: number, threshold: number): void {
    const p2 = InputBuffer.from(p)
    for (let i = 0; i < 16; ++i) {
   ...
   * @param {number} threshold - Threshold value.
   */
  public simpleHFilter16(p: InputBuffer<Uint8Array>, stride: number, threshold: number): void {
    const p2 = InputBuffer.from(p)
    for (let i = 0; i < 16; ++i) {
   ...
   * @param {number} threshold - Threshold value.
   */
  public simpleVFilter16i(p: InputBuffer<Uint8Array>, stride: number, threshold: number): void {
    const p2 = InputBuffer.from(p)
    for (let k = 3; k > 0; --k) {
      p2.offset += 4 * stride
   ...
   * @param {number} threshold - Threshold value.
   */
  public simpleHFilter16i(p: InputBuffer<Uint8Array>, stride: number, threshold: number): void {
    const p2 = InputBuffer.from(p)
    for (let k = 3; k > 0; --k) {
      p2.offset += 4
   ...
   */
  public transformOne(src: InputBuffer<Int16Array>, dst: InputBuffer<Uint8Array>): void {
    ...
    for (let i = 0; i < 4; ++i) {
      ...
      // [-3783, 3783]
      const c = VP8Filter.mul(src.get(si + 4), VP8Filter.kC2) - VP8Filter.mul(src.get(si + 12), VP8Filter.kC1)
      // [-3785, 3781]
      const d = VP8Filter.mul(src.get(si + 4), VP8Filter.kC1) + VP8Filter.mul(src.get(si + 12), VP8Filter.kC2)
      // [-7881, 7875]
      t[tmp++] = a + d
      // [-7878, 7878]
      t[tmp++] = b + c
    ...
    for (let i = 0; i < 4; ++i) {
      ...
      const a = dc + t[tmp + 8]
      const b = dc - t[tmp + 8]
      const c = VP8Filter.mul(t[tmp + 4], VP8Filter.kC2) - VP8Filter.mul(t[tmp + 12], VP8Filter.kC1)
      const d = VP8Filter.mul(t[tmp + 4], VP8Filter.kC1) + VP8Filter.mul(t[tmp + 12], VP8Filter.kC2)
   ...
   */
  public transform(src: InputBuffer<Int16Array>, dst: InputBuffer<Uint8Array>, doTwo: boolean): void {
   ...
   * @param {InputBuffer<Uint8Array>} dst - The destination buffer to store Uint8Array data.
   */
  public transformUV(src: InputBuffer<Int16Array>, dst: InputBuffer<Uint8Array>): void {
   ...
   * @param {InputBuffer<Uint8Array>} dst - The destination buffer to store Uint8Array data.
   */
  public transformDC(src: InputBuffer<Int16Array>, dst: InputBuffer<Uint8Array>): void {
   ...
   * @param {InputBuffer<Uint8Array>} dst - The destination buffer to store Uint8Array data.
   */
  public transformDCUV(src: InputBuffer<Int16Array>, dst: InputBuffer<Uint8Array>): void {
    if (src.get(0 * 16) !== 0) {
   ...
   * @param {InputBuffer<Uint8Array>} dst - The destination buffer to store Uint8Array data.
   */
  public transformAC3(src: InputBuffer<Int16Array>, dst: InputBuffer<Uint8Array>): void {
    const a = src.get(0) + 4
