...
export class PvrEncoder implements Encoder {
   ...
   */
  private static calculateBoundingBoxRgb(bitmap: MemoryImage, blockX: number, blockY: number): PvrColorBoundingBox {
   ...
   * @returns {PvrColorBoundingBox} The calculated bounding box
   */
  private static calculateBoundingBoxRgba(bitmap: MemoryImage, blockX: number, blockY: number): PvrColorBoundingBox {
