...
export class IfdSByteValue extends IfdValue {
   ...
   */
  public static data(data: InputBuffer<Uint8Array>, offset?: number, length?: number): IfdSByteValue {
  ...
  public equals(other: IfdValue): boolean {
    return (
      other instanceof IfdSByteValue && this.length === other.length && ArrayUtils.equals(this._value, other._value)
    )
  }
