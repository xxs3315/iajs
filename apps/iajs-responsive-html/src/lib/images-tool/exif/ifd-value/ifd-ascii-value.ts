...
export class IfdAsciiValue extends IfdValue {
   ...
   */
  public static data(data: InputBuffer<Uint8Array>, length: number): IfdAsciiValue {
  ...
  public equals(other: IfdValue): boolean {
    return other instanceof IfdAsciiValue && this.length === other.length && this._value === this._value
  }
