...
export class IfdSLongValue extends IfdValue {
   ...
   */
  public static data(data: InputBuffer<Uint8Array>, length: number): IfdSLongValue {
  ...
  public equals(other: IfdValue): boolean {
    return (
      other instanceof IfdSLongValue && this.length === other.length && ArrayUtils.equals(this._value, other._value)
    )
  }
