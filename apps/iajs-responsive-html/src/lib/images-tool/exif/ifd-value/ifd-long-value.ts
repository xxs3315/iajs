...
export class IfdLongValue extends IfdValue {
   ...
   */
  public static data(data: InputBuffer<Uint8Array>, length: number): IfdLongValue {
  ...
  public equals(other: IfdValue): boolean {
    return other instanceof IfdLongValue && this.length === other.length && ArrayUtils.equals(this._value, other._value)
  }
