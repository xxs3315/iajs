...
export class IfdSRationalValue extends IfdValue {
   ...
   */
  public static data(data: InputBuffer<Uint8Array>, length: number): IfdSRationalValue {
   ...
   * @param {number} [index=0] - The index of the value.
   */
  public setRational(numerator: number, denomitator: number, index: number = 0): void {
