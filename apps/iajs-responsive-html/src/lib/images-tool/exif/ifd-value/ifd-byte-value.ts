...
export class IfdByteValue extends IfdValue {
   ...
   */
  public static data(data: InputBuffer<Uint8Array>, offset?: number, length?: number): IfdByteValue {
  ...
  public equals(other: IfdValue): boolean {
    return other instanceof IfdByteValue && this.length === other.length && ArrayUtils.equals(this._value, other._value)
  }
