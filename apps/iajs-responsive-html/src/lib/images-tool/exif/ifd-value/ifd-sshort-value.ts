...
export class IfdSShortValue extends IfdValue {
   ...
   */
  public static data(data: InputBuffer<Uint8Array>, length: number): IfdSShortValue {
  ...
  public equals(other: IfdValue): boolean {
    return (
      other instanceof IfdSShortValue && this.length === other.length && ArrayUtils.equals(this._value, other._value)
    )
  }
