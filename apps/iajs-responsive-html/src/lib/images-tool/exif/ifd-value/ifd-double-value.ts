...
export class IfdDoubleValue extends IfdValue {
   ...
   */
  public static data(data: InputBuffer<Uint8Array>, length: number): IfdDoubleValue {
  ...
  public equals(other: IfdValue): boolean {
    return (
      other instanceof IfdDoubleValue && this.length === other.length && ArrayUtils.equals(this._value, other._value)
    )
  }
