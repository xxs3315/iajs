...
export class IfdShortValue extends IfdValue {
   ...
   */
  public static data(data: InputBuffer<Uint8Array>, length: number): IfdShortValue {
  ...
  public equals(other: IfdValue): boolean {
    return (
      other instanceof IfdShortValue && this.length === other.length && ArrayUtils.equals(this._value, other._value)
    )
  }
