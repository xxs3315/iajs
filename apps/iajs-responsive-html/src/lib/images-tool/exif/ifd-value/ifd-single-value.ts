...
export class IfdSingleValue extends IfdValue {
   ...
   */
  public static data(data: InputBuffer<Uint8Array>, length: number): IfdSingleValue {
  ...
  public equals(other: IfdValue): boolean {
    return (
      other instanceof IfdSingleValue && this.length === other.length && ArrayUtils.equals(this._value, other._value)
    )
  }
