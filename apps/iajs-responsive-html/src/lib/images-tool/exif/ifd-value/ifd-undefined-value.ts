...
export class IfdUndefinedValue extends IfdValue {
   ...
   */
  public static data(data: InputBuffer<Uint8Array>, offset?: number, length?: number): IfdUndefinedValue {
  ...
  public equals(other: IfdValue): boolean {
    return (
      other instanceof IfdUndefinedValue && this.length === other.length && ArrayUtils.equals(this._value, other._value)
    )
  }
