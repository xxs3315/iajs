...
export { OutputBuffer, OutputBufferInitOptions } from './common/output-buffer.js'
...
export { BufferEncoding, CompressionLevel, TypedArray } from './common/typings.js'
...
export { JpegChroma, JpegEncoder, JpegEncoderEncodeOptions } from './formats/jpeg-encoder.js'
...
export { MemoryImageData, MemoryImageDataGetBytesOptions } from './image/image-data.js'
...
export function findDecoderForNamedImage(name: string): Decoder | undefined {
  ...
  if (n.endsWith('.pnm') || n.endsWith('.pbm') || n.endsWith('.pgm') || n.endsWith('.ppm')) {
    return new PnmDecoder()
  }
  if (n.endsWith('.pvr')) {
    return new PvrDecoder()
 ...
 */
export function decodeImage(opt: DecodeImageLargestOptions): MemoryImage | undefined {
 ...
 * @returns {MemoryImage | undefined} The decoded MemoryImage or undefined if no decoder is found.
 */
export function decodeImageByMimeType(opt: DecodeImageByMimeTypeOptions): MemoryImage | undefined {
 ...
 */
export function encodeImageByMimeType(opt: EncodeImageByMimeTypeOptions): Uint8Array | undefined {
 ...
 * @returns {MemoryImage | undefined} The decoded MemoryImage or undefined if decoding fails.
 */
export function decodePng(opt: DecodeMultiframeOptions): MemoryImage | undefined {
  const dataUint8 = new Uint8Array(opt.data)
 ...
 * @returns {MemoryImage | undefined} The decoded MemoryImage or undefined if decoding fails.
 */
export function decodeTga(opt: DecodeMultiframeOptions): MemoryImage | undefined {
  const dataUint8 = new Uint8Array(opt.data)
 ...
 * @returns {MemoryImage | undefined} The decoded MemoryImage or undefined if decoding fails.
 */
export function decodeWebP(opt: DecodeMultiframeOptions): MemoryImage | undefined {
  const dataUint8 = new Uint8Array(opt.data)
 ...
 * @returns {MemoryImage | undefined} The decoded MemoryImage or undefined if decoding fails.
 */
export function decodeGif(opt: DecodeMultiframeOptions): MemoryImage | undefined {
  const dataUint8 = new Uint8Array(opt.data)
 ...
 * @returns {MemoryImage | undefined} The decoded MemoryImage or undefined if decoding fails.
 */
export function decodeTiff(opt: DecodeMultiframeOptions): MemoryImage | undefined {
  const dataUint8 = new Uint8Array(opt.data)
 ...
 * @returns {MemoryImage | undefined} The decoded MemoryImage or undefined if decoding fails.
 */
export function decodeIco(opt: DecodeImageLargestOptions): MemoryImage | undefined {
  const dataUint8 = new Uint8Array(opt.data)
