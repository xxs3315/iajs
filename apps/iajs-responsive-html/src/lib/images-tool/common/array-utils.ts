...
export abstract class ArrayUtils {
   ...
   */
  public static copyInt8(from: Int8Array, begin?: number, end?: number): Int8Array {
   ...
   */
  public static copyUint8(from: Uint8Array, begin?: number, end?: number): Uint8Array {
   ...
   */
  public static copyInt16(from: Int16Array, begin?: number, end?: number): Int16Array {
   ...
   */
  public static copyUint16(from: Uint16Array, begin?: number, end?: number): Uint16Array {
   ...
   */
  public static copyInt32(from: Int32Array, begin?: number, end?: number): Int32Array {
   ...
   */
  public static copyUint32(from: Uint32Array, begin?: number, end?: number): Uint32Array {
   ...
   */
  public static copyFloat32(from: Float32Array, begin?: number, end?: number): Float32Array {
   ...
   */
  public static copyFloat64(from: Float64Array, begin?: number, end?: number): Float64Array {
   ...
   */
  public static copy(from: TypedArray, begin?: number, end?: number): TypedArray {
   ...
   */
  public static equals(a1: TypedArray | unknown[], a2: TypedArray | unknown[]): boolean {
    if (a1 === a2) return true
    if (a1.length !== a2.length) return false
    for (let i = 0, l = a1.length; i < l; i++) {
      if (ArrayUtils.isNumArrayOrTypedArray(a1[i]) && ArrayUtils.isNumArrayOrTypedArray(a2[i])) {
        if (!ArrayUtils.equals(a1[i] as TypedArray | unknown[], a2[i] as TypedArray | unknown[])) return false
      } else if (a1[i] !== a2[i]) {
        return false
      }
    }
  ...
  public static isNumArrayOrTypedArray(obj: unknown): boolean {
    return Boolean(
      obj &&
        typeof obj === 'object' &&
        ((Array.isArray(obj) && (obj as Array<unknown>).every((v) => typeof v === 'number')) ||
