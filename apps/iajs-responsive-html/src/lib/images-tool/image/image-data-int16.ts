...
export class MemoryImageDataInt16 implements MemoryImageData, Iterable<Pixel> {
  ...
  constructor(width: number, height: number, numChannels: number, data?: Int16Array) {
    ...
    this._data = data ?? new Int16Array(this._width * this._height * this._numChannels)
  }
   ...
   */
  public static from(other: MemoryImageDataInt16, skipPixels = false): MemoryImageDataInt16 {
    const data = skipPixels ? new Int16Array(other.data.length) : other.data.slice()
