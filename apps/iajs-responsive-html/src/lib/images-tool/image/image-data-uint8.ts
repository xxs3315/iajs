...
export class MemoryImageDataUint8 implements MemoryImageData, Iterable<Pixel> {
  ...
  constructor(width: number, height: number, numChannels: number, data?: Uint8Array) {
    ...
    this._data = data ?? new Uint8Array(this._width * this._height * this._numChannels)
  }
   ...
   */
  public static palette(width: number, height: number, palette?: Palette): MemoryImageDataUint8 {
   ...
   * @returns {MemoryImageDataUint8} A new MemoryImageDataUint8 instance.
   */
  public static from(other: MemoryImageDataUint8, skipPixels = false): MemoryImageDataUint8 {
