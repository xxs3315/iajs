...
export class PixelFloat16 implements Pixel, Iterable<Pixel>, Iterator<Pixel> {
   ...
   */
  public get r(): number {
    return this.numChannels > 0 ? Float16.float16ToDouble(this.data[this._index]) : 0
  }
   ...
   */
  public get g(): number {
    return this.numChannels > 1 ? Float16.float16ToDouble(this.data[this._index + 1]) : 0
  }
   ...
   */
  public get b(): number {
    return this.numChannels > 2 ? Float16.float16ToDouble(this.data[this._index + 2]) : 0
  }
   ...
   */
  public get a(): number {
    return this.numChannels > 3 ? Float16.float16ToDouble(this.data[this._index + 3]) : 0
  }
  ...
  public setPosition(x: number, y: number): void {
    this._x = x
    this._y = y
    this._index = this._y * this._image.width * this._image.numChannels + this._x * this._image.numChannels
  }
  ...
  public getChannel(channel: number | Channel): number {
    if (channel === Channel.luminance) {
      ...
      return channel < this.numChannels ? Float16.float16ToDouble(this.data[this._index + channel]) : 0
    }
  }
