;(function (e, t) {
      ...
      function t(e, t) {
        ;(this.name = r),
          e
            ...
            : ((this.message = F[n] || r), (this.inner = null))
      }
            ...
            : (function t(n, r, i, o) {
                if (n.idbdb && (n._state.openComplete || me.letThrough || n._vip)) {
                  ...
                  try {
                    ...
                    return e.name === z.InvalidState && n.isOpen() && 0 < --n._state.PR1398_maxLoop
                    ...
                    indexes: Qt(t.indexNames)
                      ...
                      .map(function (e) {
                        var t = e.name,
                          ...
                          r = e.multiEntry,
                          e = e.keyPath,
                          r = { name: t, compound: k(e), keyPath: e, unique: n, multiEntry: r, extractKey: $t(e) }
                        return (i[Xt(e)] = r)
                      }),
      ...
      b(t.objectStoreNames, 0).forEach(function (e) {
        for (
          var t = u.objectStore(e),
            n = Vt(zt((a = t.keyPath)), a || '', !0, !1, !!t.autoIncrement, a && 'string' != typeof a, !0),
            r = [],
            i = 0;
        ...
        t[e]
          ...
          : (t[e] = (function e(t) {
              var n,
                ...
                i = {}
              for (n in t)
                m(t, n) && ((r = t[n]), (i[n] = !r || 'object' != typeof r || K.has(r.constructor) ? r : e(r)))
              return i
            })(n[e]))
      }),
      t
          ...
          return _(_({}, y), {
            mutate: function (e) {
                            ...
                            return a({ type: 'delete', keys: t, trans: r }).then(function (e) {
                              return 0 < e.numFailures
                                ...
                                : t.length < o
                                  ...
                                  : n(r, _(_({}, i), { lower: t[t.length - 1], lowerOpen: !0 }), o)
                            })
                          })
                      })(e.trans, e.range, 1e4)
                    },
              ...
              function a(c) {
                ...
                return (
                  'delete' !== (c = 'add' === c.type || 'put' === c.type ? _(_({}, c), { keys: f }) : _({}, c)).type &&
  ...
  function Qn(e, d, t, n, r, i) {
    ...
    return t === e
      ...
      : (t.sort(function (e, t) {
        ...
        d.limit &&
          d.limit < 1 / 0 &&
          (t.length > d.limit ? (t.length = d.limit) : e.length === d.limit && t.length < d.limit && (r.dirty = !0)),
        i ? Object.freeze(t) : t)
  }
  function Gn(e, t) {
    return (
      ...
      return _(_({}, k), {
        ...
        table: function (c) {
          ...
          return _(_({}, l), {
            mutate: function (t) {
              var e = me.trans
              if (i.outbound || 'disabled' === e.db._options.cache || e.explicit || 'readwrite' !== e.idbtrans.mode)
                return l.mutate(t)
  ...
  function tr(e, t) {
    ...
    ;(this._options = t =
      _({ addons: tr.addons, autoOpen: !0, indexedDB: n.indexedDB, IDBKeyRange: n.IDBKeyRange, cache: 'cloned' }, t)),
  ...
  r(
    ...
    'undefined' != typeof dispatchEvent &&
      ...
      (Nt(Mt, function (e) {
        cr || ((e = new CustomEvent(Ft, { detail: e })), (cr = !0), dispatchEvent(e), (cr = !1))
      }),
