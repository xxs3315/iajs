    ...
    plugins: [
      ...
      generatePackageJson({
        baseContents: (pkg) => {
          ...
          pkg.devDependencies = {}
          pkg.dependencies = {}
          pkg.main = 'umd/iajs-plugin-crop.js'
          pkg.module = 'iajs-plugin-crop.js'
          pkg.types = 'iajs-plugin-crop.d.ts'
          pkg.files = ['iajs-plugin-crop.d.ts', 'iajs-plugin-crop.js', 'umd']
          return pkg
        },
      }),
      // obfuscator({
